...
class AstParser {
    ...
    scopeTree:any;
    currentScope: number = 0;
    firstVar : any;
    secondVar:any;
    differentPointer:any = 0;
    ...
    parseSaStatementList(){
        if (
            this.tokenStream[this.differentPointer][1] == 'Print Statement' ||
    ...
    parseExpr() {
        ...
        else if (this.tokenStream[this.tokenPointer][1] == "Type Bool" || this.tokenStream[this.tokenPointer][1] == "Left Paren") { this.parseBooleanExpression() }
